 ...
 * действительно не нуждается в поддержании какого-либо состояния между вызовами алгоритма.
 */
public class AStarPathfinder {
    /**
     * Эта константа содержит максимальный предел отсечения для стоимости путей.
     * Если конкретная маршрутная точка превышает этот предел затрат, она отбрасывается.
     **/
    ...
    /**
     * Этот статический вспомогательный метод берет путевую точку и
     * генерирует все допустимые "следующие шаги" из этой путевой точки.
     * Новые путевые точки добавляются в коллекцию "открытые путевые точки" переданного объекта состояния А*.
     **/
    ...
    /**
     * Оценивает стоимость путешествия между двумя указанными точками.
